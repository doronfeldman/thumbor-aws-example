...
ThumborUrlBuilder.prototype = {
	...
	setImagePath: function (imagePath) {
		var newImagePath = (imagePath.charAt(0) === '/') ? imagePath.substring(1, imagePath.length) : imagePath;
		if (decodeURIComponent(newImagePath) === newImagePath) {
			newImagePath = encodeURIComponent(newImagePath);
		}
	...
	buildUrl: function () {
		...
		if (this.THUMBOR_SECURITY_KEY) {
			...
			var key = CryptoJS.HmacSHA1(operation + this.imagePath, this.THUMBOR_SECURITY_KEY);
